...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blogs_blog', 'type',
                      self.gf('django.db.models.fields.CharField')(default='blog', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.type'
        db.delete_column(u'blogs_blog', 'type')
    ...
    models = {
        ...
        u'blogs.category': {
            ...
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blogs'", 'to': u"orm['blogs.Blog']"}),
            'date_available': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'db_index': 'True'}),
            'date_insert': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
