...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Blog.main_image'
        db.alter_column(u'blogs_blog', 'main_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True))

    def backwards(self, orm):
        db.alter_column(u'blogs_blog', 'main_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image']))
