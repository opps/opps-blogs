...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogChannelRelated'
        db.create_table(u'blogs_blogchannelrelated', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Blog'])),
            ('related', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['channels.Channel'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'blogs', ['BlogChannelRelated'])


    def backwards(self, orm):
        # Deleting model 'BlogChannelRelated'
        db.delete_table(u'blogs_blogchannelrelated')
