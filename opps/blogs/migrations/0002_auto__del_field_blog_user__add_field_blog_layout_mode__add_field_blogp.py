...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field mirror_site on 'BlogLink'
        m2m_table_name = db.shorten_name(u'blogs_bloglink_mirror_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bloglink', models.ForeignKey(orm[u'blogs.bloglink'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['bloglink_id', 'site_id'])

        # Adding field 'Blog.layout_mode'
        db.add_column(u'blogs_blog', 'layout_mode',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=200),
                      keep_default=False)

        # Adding M2M table for field mirror_site on 'Blog'
        m2m_table_name = db.shorten_name(u'blogs_blog_mirror_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        # Adding M2M table for field mirror_site on 'Category'
        m2m_table_name = db.shorten_name(u'blogs_category_mirror_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm[u'blogs.category'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['category_id', 'site_id'])

        # Adding field 'BlogPost.accept_comments'
        db.add_column(u'blogs_blogpost', 'accept_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Blog.user'
        raise RuntimeError("Cannot reverse this migration. 'Blog.user' and its values cannot be restored.")
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['%s.%s']" % (User._meta.app_label. User._meta.module_name), 'symmetrical': 'False'})
        },
        u'blogs.bloglink': {
