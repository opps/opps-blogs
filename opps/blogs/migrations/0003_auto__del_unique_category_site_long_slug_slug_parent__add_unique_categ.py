...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Category', fields ['site', 'blog', 'long_slug']
        db.create_unique(u'blogs_category', ['site_id', 'blog_id', 'long_slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['site', 'blog', 'long_slug']
        db.delete_unique(u'blogs_category', ['site_id', 'blog_id', 'long_slug'])
