...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blogs_blog', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['images.Image']),
                      keep_default=False)

        # Adding field 'Blog.description'
        db.add_column(u'blogs_blog', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'blogs_blog', 'main_image_id')

        # Deleting field 'Blog.description'
        db.delete_column(u'blogs_blog', 'description')
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['images.Image']"}),
