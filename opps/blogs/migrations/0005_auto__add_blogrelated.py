...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogRelated'
        db.create_table(u'blogs_blogrelated', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'blogrelated_blog', null=True, on_delete=models.SET_NULL, to=orm['blogs.Blog'])),
            ('related', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'blogrelated_related', null=True, on_delete=models.SET_NULL, to=orm['blogs.Blog'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'blogs', ['BlogRelated'])


    def backwards(self, orm):
        # Deleting model 'BlogRelated'
        db.delete_table(u'blogs_blogrelated')
