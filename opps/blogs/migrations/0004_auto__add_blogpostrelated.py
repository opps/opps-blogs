...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogPostRelated'
        db.create_table(u'blogs_blogpostrelated', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blogpost', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blogpostrelated_blogpost', null=True, on_delete=models.SET_NULL, to=orm['blogs.BlogPost'])),
            ('related', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blogpostrelated_related', null=True, on_delete=models.SET_NULL, to=orm['blogs.BlogPost'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'blogs', ['BlogPostRelated'])


    def backwards(self, orm):
        # Deleting model 'BlogPostRelated'
        db.delete_table(u'blogs_blogpostrelated')
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layout_mode': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '200'}),
            ...
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.CustomUser']", 'symmetrical': 'False'})
        },
        u'blogs.bloglink': {
        ...
        u'blogs.blogpost': {
            ...
            'content': ('django.db.models.fields.TextField', [], {}),
            'headline': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'related_blogposts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'blogpost_relatedblogposts'", 'to': u"orm['blogs.BlogPost']", 'through': u"orm['blogs.BlogPostRelated']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'short_title': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
        ...
        u'blogs.blogpostrelated': {
            'Meta': {'ordering': "('order',)", 'object_name': 'BlogPostRelated'},
            'blogpost': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'blogpostrelated_blogpost'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['blogs.BlogPost']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'related': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'blogpostrelated_related'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['blogs.BlogPost']"})
        },
        ...
        u'blogs.category': {
            'Meta': {'ordering': "['name', 'parent__id', 'published']", 'unique_together': "(('site', 'blog', 'long_slug'),)", 'object_name': 'Category'},
